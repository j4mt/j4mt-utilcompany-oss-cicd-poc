 ...
 */
public class OSSSignIn extends OSSBasePage {
    ...
    public OSSSignIn inputSignInDetails(String email, String password) {
    ...
    public OSSSignIn clickSignInButton() {
    ...
    public OSSSignIn signInto(String email, String password) {
