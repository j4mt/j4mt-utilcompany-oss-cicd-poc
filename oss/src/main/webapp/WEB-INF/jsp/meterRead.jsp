            ...
            <div class="panel-body">
                ...
                <form:form modelAttribute="meterReadForm" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <form:input path="elecRead" class="form-control" placeholder="Enter Electricity Reading"/>
                    ...
                    <div class="form-group">
                        ...
                        <form:input path="gasRead" class="form-control" placeholder="Enter Gas Reading"/>
